...
class Careers extends React.Component<Props, State> {
  ...
  constructor(props: Props, context: null) {
    ...
    self.onUpdatedItem = this.onUpdatedItem.bind(this);
  }
